...
<section class="about-v2">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<?php if($page_slug=="payment"){ 
					include('payment.php');}
				elseif($page_slug=="our-services"){ 
					include('our-services.php');}
				// }elseif($page_slug=="laboratory-testing"){
				// 	include('laboratory-testing.php');
				elseif($page_slug=="geo5"){ 
					include('geo5-content.php'); 
				}
				elseif($page_slug=="authorized-distributor"){ 
					include('authorized-distributor-content.php'); 
				}
				elseif($page_slug=="it-digital-services"){ 
					include('it-digital-services.php'); 
				}
		...
		<div class="row">
			<div class="col-md-12">
				<?php
					...
					{
							echo "
							<h2 class='title'>Our Documents</h2>
						...
						";
							...
							if($page_slug == 'about-us')
							{
								$statement = $pdo->prepare("SELECT file_id, file_title, file_name FROM tbl_file");
								$statement->execute();
								$result = $statement->fetchAll(PDO::FETCH_ASSOC);						
								foreach ($result as $row) {
									$result++;
							      ...
							      <td><a download="<?php echo $row['file_name']; ?>" href="<?php echo BASE_URL; ?>assets/uploads/<?php echo $row['file_name']; ?>">Download</a></td>
							    </tr>
									<?php
								}
			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-3">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title"><strong>Main Office</strong></h3>
							</div>
								...
								<table>
									<tr>
										...
										<td valign="top" style="padding-left:3px" class="colspan-2">
											<p> 14155 Sullyfield Circle,<br>Suite H, Chantilly VA 20151</p>
										</td>
									</tr>
									<tr>
					...
					<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title"><strong>Maryland Office</strong></h3>
							</div>
							<div class="panel-body">
								<table>
									<tr>
					...
					<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title"><strong>Hampton Office</strong></h3>
							</div>
							<div class="panel-body">
								<table>
									<tr>
					...
					<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title"><strong>DC Office</strong></h3>
							</div>
							<div class="panel-body">
								<table>
									<tr>
				...
				<div class="blog-grid">
					<div class="row">
						<div class="col-md-12">
							...
							<?php if(!$total): ?>
							<p style="color:red;"><?php echo "Sorry, no blogs found."; ?></p>
							<?php else: ?>
								...
								<div class="post-item">
									<div class="image-holder">
										<?php if($row['video_url']!=NULL) { ?>
											<iframe width="300" height="200" src=<?php echo "https://www.youtube.com/embed/".$row['video_url']; ?> title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
										<?php }else{ ?>
