						...
						<div class="col-md-12">							
							...
							<div class="post-item">
								...
								<div class="text text-single">
									...
									<?php if($video!=NULL) { ?>
										<iframe width="600" height="400" src=<?php echo "https://www.youtube.com/embed/".$video; ?> title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
									<?php } ?>
